...
class ChapterMaintainController extends AdminController
{
    /**
    ...
    {
        $grid = new Grid(new ChapterMaintain());
        $grid->model()->latest();
    ...
    {
        $show = new Show(ChapterMaintain::findOrFail($id));
    ...
    {
        $form = new Form(new ChapterMaintain());
