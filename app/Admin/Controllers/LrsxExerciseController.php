...
use App\LrsxExercise;
use Encore\Admin\Controllers\AdminController;
use Encore\Admin\Form;
use Encore\Admin\Grid;
use Encore\Admin\Show;

class LrsxExerciseController extends AdminController
{
    /**
    ...
    {
        $grid = new Grid(new LrsxExercise());
    ...
    {
        $show = new Show(LrsxExercise::findOrFail($id));
    ...
    {
        $form = new Form(new LrsxExercise());
