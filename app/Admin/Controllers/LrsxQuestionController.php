...
use App\LrsxQuestion;
use Encore\Admin\Controllers\AdminController;
use Encore\Admin\Form;
use Encore\Admin\Grid;
use Encore\Admin\Show;

class LrsxQuestionController extends AdminController
{
    /**
    ...
    {
        $grid = new Grid(new LrsxQuestion());
    ...
    {
        $show = new Show(LrsxQuestion::findOrFail($id));
    ...
    {
        $form = new Form(new LrsxQuestion());
