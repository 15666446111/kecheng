...
class MaintainController extends AdminController
{
    ...
    {
        $show = new Show(Maintain::findOrFail($id));
    ...
    {
        $form = new Form(new Maintain());

        $form->text('title', __('标题'));

        $form->select('province', '所属章')->options(ChapterMaintain::where('chapter_open', '1')->get()->pluck('chapter_title', 'id'))->load('section_id', '/getSection');
