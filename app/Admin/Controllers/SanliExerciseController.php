...
use App\SanliExercise;
use Encore\Admin\Controllers\AdminController;
use Encore\Admin\Form;
use Encore\Admin\Grid;
use Encore\Admin\Show;

class SanliExerciseController extends AdminController
{
    /**
    ...
    {
        $grid = new Grid(new SanliExercise());
    ...
    {
        $show = new Show(SanliExercise::findOrFail($id));
