...
use App\SanliMaintain;
use Encore\Admin\Controllers\AdminController;
use Encore\Admin\Form;
use Encore\Admin\Grid;
use Encore\Admin\Show;

class SanliMaintainController extends AdminController
{
    /**
    ...
    {
        $grid = new Grid(new SanliMaintain());
    ...
    {
        $show = new Show(SanliMaintain::findOrFail($id));
        ...
        $show->questions('题目列表', function ($questions) {
            ...
            $questions->resource('/admin/sanli-questions');
    ...
    protected function form()
    {
        ...
        $form->select('exercise_id', __('地区车型'))->options(\App\SanliExercise::pluck('title', 'id')->toArray());
