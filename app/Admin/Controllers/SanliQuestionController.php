...
use App\SanliQuestion;
use Encore\Admin\Controllers\AdminController;
use Encore\Admin\Form;
use Encore\Admin\Grid;
use Encore\Admin\Show;

class SanliQuestionController extends AdminController
{
    /**
    ...
    {
        $grid = new Grid(new SanliQuestion());
    ...
    {
        $show = new Show(SanliQuestion::findOrFail($id));
    ...
    {
        $form = new Form(new SanliQuestion());
