...
use App\Secret2Question;
use Encore\Admin\Controllers\AdminController;
use Encore\Admin\Form;
use Encore\Admin\Grid;
use Encore\Admin\Show;

class Secret2QuestionController extends AdminController
{
    /**
     ...
     * @var string
     */
    protected $title = 'Secret2Question';
    ...
    {
        $grid = new Grid(new Secret2Question());
    ...
    {
        $show = new Show(Secret2Question::findOrFail($id));
    ...
    {
        $form = new Form(new Secret2Question());
