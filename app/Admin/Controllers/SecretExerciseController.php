...
use App\SecretExercise;
use Encore\Admin\Controllers\AdminController;
use Encore\Admin\Form;
use Encore\Admin\Grid;
use Encore\Admin\Show;

class SecretExerciseController extends AdminController
{
    /**
    ...
    {
        $grid = new Grid(new SecretExercise());
    ...
    {
        $show = new Show(SecretExercise::findOrFail($id));
    ...
    {
        $form = new Form(new SecretExercise());
