...
use App\SecretMaintain;
use Encore\Admin\Controllers\AdminController;
use Encore\Admin\Form;
use Encore\Admin\Grid;
use Encore\Admin\Show;

class SecretMaintainController extends AdminController
{
    /**
    ...
    {
        $grid = new Grid(new SecretMaintain());
    ...
    {
        $show = new Show(SecretMaintain::findOrFail($id));
        ...
        $show->questions('题目列表', function ($questions) {
            ...
            $questions->resource('/admin/secret-questions');
    ...
    {
        $form = new Form(new SecretMaintain());
