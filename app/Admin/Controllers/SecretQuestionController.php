...
class SecretQuestionController extends AdminController
{
    /**
     ...
     * @var string
     */
    protected $title = 'SecretQuestion';
    ...
    {
        $grid = new Grid(new SecretQuestion());
    ...
    {
        $show = new Show(SecretQuestion::findOrFail($id));
    ...
    {
        $form = new Form(new SecretQuestion());
