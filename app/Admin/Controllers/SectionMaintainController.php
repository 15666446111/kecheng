...
use App\SectionMaintain;
use Encore\Admin\Controllers\AdminController;
use Encore\Admin\Form;
use Encore\Admin\Grid;
use Encore\Admin\Show;

class SectionMaintainController extends AdminController
{
    /**
    ...
    {
        $grid = new Grid(new SectionMaintain());
        $grid->model()->latest();
    ...
    {
        $show = new Show(SectionMaintain::findOrFail($id));
