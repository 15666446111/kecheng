...
class CreateSequentialMaintainsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sequential_maintains', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('sequential_maintains');
    }
}
